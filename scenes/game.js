...
export class Game extends Phaser.Scene
{
    ...
    preload()
    {
    this.load.json('levelData', './assets/levels/level0.json');
    ...
    {
        let gridWidth = levelData.stage.width
        let gridHeight = levelData.stage.height
        let matrix = [];
    ...
    ecsConfig() {
        ...
        this.spriteSystem = createSpriteSystem(this, ['redSquare', 'greenSquare'])
    ...
    addMap(){
            ...
            this.frameBackground = this.add.image(
                this.gridOriginX + this.gridWidthPx/2, //this.gridOriginX,  // Centrer l'image en X
                this.gridOriginY + this.gridHeightPx/2, // Centrer l'image en Y
                'floor'         // Nom de l'image
            );
    
            // Ajuster la taille de l'image si nécessaire
            this.frameBackground.setDisplaySize(this.gridWidthPx+this.cellWidth, this.gridHeightPx+this.cellHeight);
